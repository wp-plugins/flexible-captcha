	...
	<div id="poststuff" class="metabox-holder">
      <div id="post-body">
        <div id="post-body-content">
	        <div id="FC-default-dim-div" class="stuffbox" style="width: 98%">
			  ...
			  <div class="inside">
				...
				<input type="button" name="submit_default_dimensions" value="Submit" onmousedown="FC_submit_default_dimensions();" />
			  </div>
		    </div>
			<br /><br />
			<div id="FC-request-key-div" class="stuffbox" style="width: 98%">
			  <h3><label for="FC_default_width">Request key</label></h3>
			  <div class="inside">
				Key: <input type="text" name="FC_request_key" id="FC_request_key" value="<?php print get_option("FC_request_key"); ?>" /><br />
				<input type="button" name="submit_request_key" value="Submit" onmousedown="FC_submit_request_key();" />
			  </div>
		    </div>
			<br /><br />
			<div id="FC-colors-div" class="stuffbox" style="width: 98%">
			  ...
			  <div class="inside">
				...
				<input type="button" name="submit_colors" value="Submit" onmousedown="FC_submit_colors();" />
			  </div>
		    </div>
			<br /><br />
			<div id="FC-general-settings-div" class="stuffbox" style="width: 98%">
			  ...
			  <div class="inside">
				...
				<input type="button" name="submit_request_key" value="Submit" onmousedown="FC_submit_general_settings();" />
			  </div>
		    </div>
			<br /><br />
			<div id="FC-font-files-div" class="stuffbox" style="width: 98%">
